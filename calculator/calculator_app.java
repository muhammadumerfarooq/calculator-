        ...
        switch(calculation_result)
        {
                case 1: // for addition
                    if ((jTextField1.getText().equals("")))
                    {
                        ...
                        ans=true;
                answer=no+Double.parseDouble(jTextField1.getText());
...
if (jTextField1.getText().contains("NaN"))
{
    jTextField1.setText("NaN");

}
else if (jTextField1.getText().contains("Infinity"))
{
...
else if (jTextField1.getText().contains("Infinity"))
{
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
         //jTextField1.setText(jTextField1.getText()+"/");
             if (!jLabel1.getText().equals("") && !(jTextField1.getText().equals("")))
          {
          ...
          else if (jLabel1.getText().equals("") &&  !(jTextField1.getText().equals(""))){
...
if (!(jTextField1.getText().equals("")))
{    Double val=  Double.parseDouble(jTextField1.getText().toString());
     val=sin(val);
jTextField1.setText(val.toString());
}
...
}else{        if (!(jLabel1.getText().equals("")) && ans==true)
         jTextField1.setText(jLabel1.getText().substring(0, jLabel1.getText().length()-1));
else
